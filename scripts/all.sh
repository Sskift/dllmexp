...
# python eval.py --model_alias llada --task mbpp --alg low_confidence --limit $LIMIT
# python eval.py --model_alias llada --task gsm8k --alg low_confidence --limit $LIMIT
...
# python eval.py --model_alias dream --task gsm8k --alg maskgit_plus --limit $LIMIT
# python eval.py --model_alias dream --task truthfulqa --alg maskgit_plus --limit $LIMIT
